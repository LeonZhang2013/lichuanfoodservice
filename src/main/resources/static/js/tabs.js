    		...
    		$.extend($.fn.tabs.methods, {   
    		    ...
    		    loadTabIframe:function(jq,params){   
    		        return jq.each(function(){   
    		            ...
    		            var $maskMessage = $('<div class="mask-message" style="z-index:3;width:auto;height:16px;line-height:16px;position:absolute;top:50%;left:50%;margin-top:-20px;margin-left:-92px;border:2px solid #d4d4d4;padding: 12px 5px 10px 30px;background: #ffffff url(\'../../css/easyui/default/images/loading.gif\') no-repeat scroll 5px center;">' + (params.iframe.message || 'loading...') + '</div>').appendTo($tabBody);   
    		    ...
    		    addIframeTab:function(jq,params){   
    		        return jq.each(function(){   
    		            ...
    		            $(this).tabs('loadTabIframe',{'id':params.tab.id,'which':params.tab.title,'iframe':params.iframe,'callback':params.callback});   
    		        });   
    		    },   
    		    /**
    		     * 更新tab的iframe内容  
