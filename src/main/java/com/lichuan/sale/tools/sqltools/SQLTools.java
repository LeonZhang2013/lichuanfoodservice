package com.lichuan.sale.tools.sqltools;
...
public class SQLTools {
    ...
    public static SqlInfo getUpdateById(Object obj, Long id) {
        return getUpdateById(obj, obj.getClass().getSimpleName().toLowerCase(), id);
    }
