...
public class XCXInfo {
    ...
    public static final String APPID = "wx47d79d30049634a2";
    public static final String SECRET = "2d8a71606ad80744b3c981c3384bfc28";
    public static final String SSL_KEY = "C:/weixin_ssl/apiclient_cert.p12";
    //微信支付使用
    ...
    public static final String REFUND_INFO_URL = "http://www.baidu.com/lichuan/wx/pay/notifyInfoRefund";//
    //签名方式，固定值
